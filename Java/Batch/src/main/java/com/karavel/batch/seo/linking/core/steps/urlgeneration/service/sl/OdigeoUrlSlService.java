...
@UrlSejlistService(applicableSites = {SitesEnum.GOVOYAGES, SitesEnum.OPODO, SitesEnum.EDREAMS})
public class OdigeoUrlSlService extends AbstractUrlGenerationService<GenerateSLUrlIn, GenerateUrlOut> {

    private IUrlGeneratorOdigeo urlGeneratorOdigeo;

    public OdigeoUrlSlService() {
        super(OdigeoUrlSlService.class);
    }


    @Override
    protected GenerateUrlOut serviceCall(GenerateSLUrlIn in) throws WatchDogException {
        return urlGeneratorOdigeo.generateUrlSL(in);
    }
    ...
    @Autowired
    public void setUrlGeneratorOdigeo(IUrlGeneratorOdigeo urlGeneratorOdigeo) {
        this.urlGeneratorOdigeo = urlGeneratorOdigeo;
    }
}
