...
@Configuration
public class LinkingRulesFpSurSlFramB2b {

    @Bean
    LinkingRules linkingRulesFpSurSlZt2FramB2b() {
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt3FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(3)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt4FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(4)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt5FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(5)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt6FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(6)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
