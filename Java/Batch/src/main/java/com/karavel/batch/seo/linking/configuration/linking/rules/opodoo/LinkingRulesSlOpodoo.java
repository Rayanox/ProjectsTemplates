...
@Configuration
public class LinkingRulesSlOpodoo {


    @Bean
    LinkingRules linkingRulesSlZt2Opodo() {
    ...
    @Bean
    LinkingRules linkingRulesSlZt3Opodo() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(3)
                .forSite(SitesEnum.OPODO)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt4Opodo() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(4)
                .forSite(SitesEnum.OPODO)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt5Opodo() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(5)
                .forSite(SitesEnum.OPODO)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt6Opodo() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(6)
                .forSite(SitesEnum.OPODO)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt7Opodo() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(7)
                .forSite(SitesEnum.OPODO)
                .forGenerationType(GenerationType.SL)
