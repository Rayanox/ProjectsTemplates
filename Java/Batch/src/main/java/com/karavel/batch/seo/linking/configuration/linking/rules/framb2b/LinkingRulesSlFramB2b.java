package com.karavel.batch.seo.linking.configuration.linking.rules.framb2b;
...
@Configuration
public class LinkingRulesSlFramB2b {


    @Bean
    LinkingRules linkingRulesSlZt2FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(2)
                .forSite(SitesEnum.FRAM)
    ...
    @Bean
    LinkingRules linkingRulesSlZt3FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(3)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt4FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(4)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt5FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(5)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt6FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(6)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt7FramB2b() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(7)
                .forSite(SitesEnum.FRAM)
                .forGenerationType(GenerationType.SL)
