...
@Configuration
public class LinkingRulesSlEdreams {


    @Bean
    LinkingRules linkingRulesSlZt2Edreams() {
    ...
    @Bean
    LinkingRules linkingRulesSlZt3Edreams() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(3)
                .forSite(SitesEnum.EDREAMS)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt4Edreams() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(4)
                .forSite(SitesEnum.EDREAMS)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt5Edreams() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(5)
                .forSite(SitesEnum.EDREAMS)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt6Edreams() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(6)
                .forSite(SitesEnum.EDREAMS)
                .forGenerationType(GenerationType.SL)
    ...
    @Bean
    LinkingRules linkingRulesSlZt7Edreams() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(7)
                .forSite(SitesEnum.EDREAMS)
                .forGenerationType(GenerationType.SL)
