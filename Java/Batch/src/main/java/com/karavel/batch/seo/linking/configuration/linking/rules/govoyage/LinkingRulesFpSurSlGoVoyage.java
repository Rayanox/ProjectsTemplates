...
@Configuration
public class LinkingRulesFpSurSlGoVoyage {

    @Bean
    LinkingRules linkingRulesFpSurSlZt2GoVoyage() {
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt3GoVoyage() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(3)
                .forSite(SitesEnum.GOVOYAGES)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt4GoVoyage() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(4)
                .forSite(SitesEnum.GOVOYAGES)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt5GoVoyage() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(5)
                .forSite(SitesEnum.GOVOYAGES)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt6GoVoyage() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(6)
                .forSite(SitesEnum.GOVOYAGES)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
