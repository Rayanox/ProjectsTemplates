...
@Configuration
public class LinkingRulesFpSurSlFramB2c {

    @Bean
    LinkingRules linkingRulesFpSurSlZt2FramB2c() {
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt3FramB2c() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(3)
                .forSite(SitesEnum.FRAMB2C)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt4FramB2c() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(4)
                .forSite(SitesEnum.FRAMB2C)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt5FramB2c() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(5)
                .forSite(SitesEnum.FRAMB2C)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
    ...
    @Bean
    LinkingRules linkingRulesFpSurSlZt6FramB2c() {
        return LinkingRuleBuilder.init()
                .forZoneLevel(6)
                .forSite(SitesEnum.FRAMB2C)
                .forGenerationType(GenerationType.TOP_HOTEL_POUR_SEJLIST)
